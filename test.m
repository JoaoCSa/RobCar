...
for i=1:320
    % obtain measurements
    [x_measured(i+1), y_measured(i+1), x_real(i+1), y_real(i+1)] = gps_estimation(x(i), y(i), x_real(i), y_real(i));
    ...
    [x(i+1), y(i+1), theta(i+1), phi(i+1), P] = ekf(x_real(i), y_real(i), theta_real(i), phi_real(i), V, omega_s(i), L, P, x_measured(i+1), y_measured(i+1), theta(i), phi(i), Q, R);
